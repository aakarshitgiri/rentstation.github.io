...
?>
          ...
          <h3><b><span style="color: #e12120;  font-family: serif;"> BUY or SELL or RENT FOR FREE </span></b></h3> 
        
          </div>


<div class="container" style="text-align: center; background-color: black; padding-top: 20px; border-radius: 5px;  ">
               

<div class="row " style="text-align: center;">


<div  style="float: left; width: 25%; margin-bottom: 16px; padding: 0 8px;">
    <h2  style="font-size:large; color: white;">Hostel Recomendation</h2>

<img style="height: 100px;" alt="100x100" src="assets/images/icon/hostel.png" alt="Card image cap"
  data-holder-rendered="true">
      </div>
   
      <div  style="float: left; width: 25%; margin-bottom: 16px; padding: 0 8px;">
    <h2  style="font-size:large; color: white;">Customized Rooms</h2>

<img style="height: 100px;" alt="100x100" src="assets/images/icon/customized-home.png" alt="Card image cap"
  data-holder-rendered="true">
      </div>
   

      <div  style="float: left; width: 25%; margin-bottom: 16px; padding: 0 8px;">
    <h2  style="font-size:large; color: white;">Pay Your Rent</h2>

<img style="height: 100px;" alt="100x100" src="assets/images/icon/pay.png" alt="Card image cap"
  data-holder-rendered="true">
      </div>

      <div x style="float: left; width: 25%; margin-bottom: 16px; padding: 0 8px;">
    <h2 style="font-size:large; color: white;color: white;">Refer & Earn</h2>

<img style="height: 100px;" alt="100x100" src="assets/images/icon/refer-earn.png" alt="Card image cap"
  data-holder-rendered="true">
      </div>
