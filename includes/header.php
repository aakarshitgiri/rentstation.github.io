...
$_SESSION['Fetch Propertiesuid']=$ret['ID'];
...
<header id="navbar-spy" class="header header-1 header-transparent header-fixed">
            <nav id="primary-menu" class="navbar navbar-fixed-top">
                ...
                <span class="icon-bar"></span>
                 ...
                 <a href="index.php"><img src="assets/images/logo.png" style="float:left;  max-height: 30px; margin-top: 30px; width: auto; transform: translate3d(0, 0, 0); " alt="RentStations">
                </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse pull-right" id="navbar-collapse-1">
                        <ul class="nav navbar-nav nav-pos-center navbar-left">
                            ...
                            <li class="has-dropdown">
                                <?php if (strlen($_SESSION['Fetch Propertiesuid']!=0)) {?>
                        ...
                        <div class="module module-login pull-left">
                            <?php if (strlen($_SESSION['Fetch Propertiesuid']==0)) {?>  
                            <a class="btn-popup" data-toggle="modal" data-target="#signupModule"> Signup | Login </a>
                            <?php } ?>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li class="active"><a href="#signup" data-toggle="tab">signup</a>
                                                    </li>
                                                </ul>
                                                <!-- Tab panes -->
                                                    ...
                                                    <div class="tab-pane" id="login">
                                                        <div class="signup-form-container text-center">
                                                            <form class="mb-0" method="post" name="signin">
                                                                ...
                                                                <div class="or-text">
<span style="color: blue">Fetch Properties</span>
                                                            </div>
