...
if(isset($_POST['login']))
  {
    ...
    if($ret>0){
      $_SESSION['Fetch Propertiesaid']=$ret['ID'];
...
<head>
    ...
    <title>Fetch Properties || Login</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><h2 style="color: blue">Fetch Properties</h2><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
