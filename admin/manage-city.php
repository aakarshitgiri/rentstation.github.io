...
{
$sid=$_GET['delid'];
$ret=mysqli_query($con,"delete from tblcity where ID='$sid'"); 
if($ret) 
{
...
?>
    ...
    <td><a href="edit-city.php?ctyid=<?php echo $row['cityid'];?>">Edit</a>  | 
    <a href="manage-city.php?delid=<?php echo $row['cityid'];?>" onClick="return confirm('Do you really want to delete?');">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
