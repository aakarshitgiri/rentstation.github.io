...
{
if (strlen($_SESSION['Fetch Propertiesuid']==0)) 
{
                            ...
                            <div class="widget--content">
                                ...
                                <div class="agent--contact">
                                    <ul class="list-unstyled">
                                        <li style="color:black;"><i class="fa fa-phone" ></i><?php echo $row1['MobileNumber'];?></li>
                                        <li style="color:black;"><i class="fa fa-envelope-o" ></i><?php echo $row1['Email'];?></li>
...
<!-- For Guest User =============================-->
<?php if($_SESSION['Fetch Propertiesuid']==0)
{ ?>
                        <div class="widget widget-request">
                            <div class="widget--title">
                                <h5>Request For This Property</h5>
                            </div>
                            <div class="widget--content">
